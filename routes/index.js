...
router.post('/api/v1/cart', authenticated, isUser, cartController.addCartItem)
router.delete('/api/v1/cart', authenticated, isUser, cartController.removeCartItem)
router.put('/api/v1/cart', authenticated, isUser, cartController.toggleCartItem)
